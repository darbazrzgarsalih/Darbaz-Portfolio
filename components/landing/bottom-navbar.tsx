...
function BottomNavbar() {
    ...
    return (
        <div className="fixed bottom-4 left-0 right-0 z-50 flex justify-center pointer-events-none">
            <div className="pointer-events-auto overflow-scroll bg-black/10 dark:bg-white/30 backdrop-blur-xs w-2.5/3 md:w-0.5/4 border border-white/30 rounded-full px-1 py-2 flex items-center  shadow-lg">
