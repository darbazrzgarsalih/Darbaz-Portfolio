...
function BottomNavbar() {
    ...
    return (
        <div className="fixed bottom-4 left-0 right-0 z-50 flex justify-center pointer-events-none">
            <div className="pointer-events-auto overflow-scroll bg-muted/10 dark:bg-muted/40 backdrop-blur-xl w-2.5/3 md:w-0.5/4 border border-muted/30 rounded-full px-1 py-2 flex items-center  shadow-lg">
