...
function TopNavbar() {
    ...
    return (
        <nav className="fixed w-full top-0 z-50 right-0 left-0 flex justify-between bg-muted/10 backdrop-blur-lg items-center py-4 px-5 border-b border-muted/30">
